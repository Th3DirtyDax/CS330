...
*
* As the weeks continue I am making adjustments to .cpp and .h files and moving them as I learn.
* Assignments are being completed in this and being saved separately, hence why the name never changes on the
* submissions and remains as the showcase applications.
*/
...
//override the color to help ensure that shading is working correctly
Mesh::Mesh(std::vector<Vertex>& vertices, std::vector<uint32_t>& elements, const glm::vec2& uvScale, const glm::vec3& color) {
